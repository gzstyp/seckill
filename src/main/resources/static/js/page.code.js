...
;(function(){
    window.winFn = {
        ...
        addOrEdit: function(title, domDivId, area, closedCall, btn3, btn3Call){
            ...
            return layer.open({
                type: 1, title: title, content: $(domDivId),//最好该元素要存放在body最外层，否则可能被其它的相对元素所影响
                area: area, resize: false, btn: btns, yes: function(index, layero){
            ...
            return layer.open({
                type: 1, title: title, content: $(domDivId), area: area, resize: false, closeBtn: 0, btn: '提交', yes: function(index, layero){
                    if(closedCall != null && closedCall != ''){
                        closedCall(index, layero);
                    }
                },
            ...
            $.ajax({
                type: "POST", url: url, dataType: "json", data: params, success: function(result){
                    succeed(result);
            ...
            layer.open({
                title: '系统提示', content: msg, offset: 'rb', shade: 0, area: 'auto', time: 4000
            });
        }
    }, window.alert = function(msg, callback){
        var al_t = (self == top) ? parent : window;
        al_t.layer.alert(msg, {
            title: '系统提示', area: 'auto', btn: ['确定'], cancel: function(index, layero){
    ...
    window.confirm = function(msg, callback){
        ...
        conf_m.layer.confirm(msg, {
            title: '系统提示', btn: ['确定', '取消'], area: 'auto',
        }, function(){
